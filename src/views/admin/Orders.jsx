                ...
                <div className="relative mt-5 overflow-x-auto">
                    <div className="w-full text-sm text-left [#D0D2D6]">
                        <div className="text-sm text-[#D0D2D6] uppercase border-b border-slate-700">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="py-3 w-[18%] font-bold">Status do Pagamento</div>
                    ...
                    <div className="text-[#D0D2D6]">
                        <div className="flex items-start justify-between border-b border-slate-700">
                            ...
                            <div onClick={(e) => setShow(!show)} className="py-3 w-[8%] font-bold"><LuArrowDown/></div>
                        </div>
                    ...
                    <div className="text-[#D0D2D6]">
                        ...
                        <div className="text-[#D0D2D6]">
                            <div className="flex items-start justify-between border-b border-slate-700">
                                ...
                                <div onClick={(e) => setShow(!show)} className="py-3 w-[8%] font-bold"><LuArrowDown/>
                                </div>
                            </div>
                            <div className={show ? 'block border-b border-slate-700 bg-[#8288ED]' : 'hidden'}>
                                <div className="flex items-start justify-between border-b border-slate-700">
                            ...
                            <div className="text-[#D0D2D6]">
                                <div className="flex items-start justify-between border-b border-slate-700">
                                    ...
                                    <div onClick={(e) => setShow(!show)} className="py-3 w-[8%] font-bold">
                                        <LuArrowDown/></div>
                                </div>
                                <div className={show ? 'block border-b border-slate-700 bg-[#8288ED]' : 'hidden'}>
                                    <div className="flex items-start justify-between border-b border-slate-700">
